...
public class OAuth2AsyncAuthenticationFlowTest {
	...
	public void shouldSendRequestToResourceUsingAuthorizationCodeAuthorizationFlow() {
		AsyncAuthentication authentication = new OAuth2AsyncAuthenticationBuilder()
				.grantType()
					.authorizationCode()
		...
		request = request.add(Header.authorization(authentication.contentAsync(request).toCompletableFuture().join()));
