...
import com.github.ljtfreitas.restify.http.netflix.client.call.hystrix.HystrixFallbackEndpointCallExecutableAdapter;
import com.github.ljtfreitas.restify.http.netflix.client.call.hystrix.OnCircuitBreaker;

@RunWith(MockitoJUnitRunner.class)
public class HystrixFallbackEndpointCallExecutableAdapterTest {
	...
	private HystrixFallbackEndpointCallExecutableAdapter<String, String, SomeType> hystrixCircuitBreakerStringExecutableAdapter;

	private HystrixFallbackEndpointCallExecutableAdapter<Future<String>, String, SomeType> hystrixCircuitBreakerFutureExecutableAdapter;
	...
	public void setup() {
		...
		hystrixCircuitBreakerStringExecutableAdapter = new HystrixFallbackEndpointCallExecutableAdapter<>(fallback);

		hystrixCircuitBreakerFutureExecutableAdapter = new HystrixFallbackEndpointCallExecutableAdapter<>(fallback);
	}
