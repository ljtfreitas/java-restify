...
public class HystrixCircuitBreakerEndpointCallExecutableAdapterTest {
	...
	private HystrixCircuitBreakerEndpointCallExecutableAdapter<String, String> hystrixCircuitBreakerStringExecutableAdapter;

	private HystrixCircuitBreakerEndpointCallExecutableAdapter<Future<String>, String> hystrixCircuitBreakerFutureExecutableAdapter;
	...
	public void setup() {
		...
		hystrixCircuitBreakerStringExecutableAdapter = new HystrixCircuitBreakerEndpointCallExecutableAdapter<>();

		hystrixCircuitBreakerFutureExecutableAdapter = new HystrixCircuitBreakerEndpointCallExecutableAdapter<>();
	}
