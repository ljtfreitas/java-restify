...
import com.github.ljtfreitas.restify.http.netflix.client.call.hystrix.HystrixCommandEndpointCallExecutableAdapter;
import com.github.ljtfreitas.restify.reflection.JavaType;
import com.netflix.hystrix.HystrixCommand;
import com.netflix.hystrix.exception.HystrixRuntimeException;

@RunWith(MockitoJUnitRunner.class)
public class HystrixCommandEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<String, String> delegate;

	private HystrixCommandEndpointCallExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		adapter = new HystrixCommandEndpointCallExecutableAdapter<>();
	...
	public void shouldCreateExecutableFromEndpointMethodWithHystrixCommandReturnType() throws Exception {
		EndpointCallExecutable<HystrixCommand<String>, String> executable = adapter
