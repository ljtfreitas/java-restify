...
public class HystrixCommandFallbackEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<String, String> delegate;

	private HystrixCommandFallbackEndpointCallExecutableAdapter<String, String, SomeType> adapter;
	...
	@Before
	public void setup() {
		adapter = new HystrixCommandFallbackEndpointCallExecutableAdapter<>(fallback);
