...
public class RxJava2SingleEndpointCallExecutableAdapterTest {
	...
	private RxJava2SingleEndpointCallExecutableAdapter<String, String> adapter;
	...
	public void setup() {
		...
		adapter = new RxJava2SingleEndpointCallExecutableAdapter<>(scheduler);
	}
	...
	public void shouldCreateExecutableFromEndpointMethodWithRxJava2SingleReturnType() throws Exception {
		AsyncEndpointCallExecutable<Single<String>, String> executable = adapter
