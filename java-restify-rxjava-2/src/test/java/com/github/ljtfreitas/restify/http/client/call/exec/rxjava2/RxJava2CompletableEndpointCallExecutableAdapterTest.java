...
public class RxJava2CompletableEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCall<Void> endpointCallMock;

	private RxJava2CompletableEndpointCallExecutableFactory adapter;
	...
	public void setup() {
		...
		adapter = new RxJava2CompletableEndpointCallExecutableFactory(scheduler);
	}
	...
	public void shouldCreateExecutableFromEndpointMethodWithRxJava2CompletableReturnType() throws Exception {
		EndpointCallExecutable<Completable, Void> executable = adapter
