...
public class RxJava2FlowableEndpointCallExecutableAdapterTest {
	...
	private RxJava2FlowableEndpointCallExecutableAdapter<String, String> adapter;
	...
	public void setup() {
		...
		adapter = new RxJava2FlowableEndpointCallExecutableAdapter<>(scheduler);
	}
	...
	public void shouldCreateExecutableFromEndpointMethodWithRxJava2FlowableReturnType() throws Exception {
		EndpointCallExecutable<Flowable<String>, String> executable = adapter
