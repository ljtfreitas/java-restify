...
public class RxJava2ObservableEndpointCallExecutableAdapterTest {
	...
	private RxJava2ObservableEndpointCallExecutableAdapter<String, String> adapter;
	...
	public void setup() {
		...
		adapter = new RxJava2ObservableEndpointCallExecutableAdapter<>(scheduler);
	}
	...
	public void shouldCreateExecutableFromEndpointMethodWithRxJava2ObservableReturnType() throws Exception {
		AsyncEndpointCallExecutable<Observable<String>, String> executable = adapter
