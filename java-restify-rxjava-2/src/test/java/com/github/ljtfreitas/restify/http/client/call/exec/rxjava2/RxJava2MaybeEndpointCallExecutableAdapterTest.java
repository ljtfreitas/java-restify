...
public class RxJava2MaybeEndpointCallExecutableAdapterTest {
	...
	private RxJava2MaybeEndpointCallExecutableAdapter<String, String> adapter;
	...
	public void setup() {
		...
		adapter = new RxJava2MaybeEndpointCallExecutableAdapter<>(scheduler);
	}
	...
	public void shouldCreateExecutableFromEndpointMethodWithRxJava2MaybeReturnType() throws Exception {
		AsyncEndpointCallExecutable<Maybe<String>, String> executable = adapter
	...
	public void shouldSubscribeErrorOnMaybeWhenCreatedExecutableWithRxJava2MaybeReturnTypeThrowException() throws Exception {
		EndpointCallExecutable<Maybe<String>, String> executable = adapter
