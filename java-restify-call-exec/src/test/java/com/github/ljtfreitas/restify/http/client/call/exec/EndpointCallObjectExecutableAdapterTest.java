...
public class EndpointCallObjectExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<String, String> delegate;

	private EndpointCallObjectExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		adapter = new EndpointCallObjectExecutableAdapter<>();
	...
	public void shouldCreateExecutableFromEndpointMethodWithEndpointallReturnType() throws Exception {
		EndpointCallExecutable<EndpointCall<String>, String> executable = adapter
