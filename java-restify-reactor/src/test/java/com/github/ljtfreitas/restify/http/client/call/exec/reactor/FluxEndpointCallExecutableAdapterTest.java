...
public class FluxEndpointCallExecutableAdapterTest {
	...
	private FluxEndpointCallExecutableAdapter<String, String> adapter;
	...
	public void setup() {
		...
		adapter = new FluxEndpointCallExecutableAdapter<>(scheduler);
	...
	public void shouldCreateExecutableFromEndpointMethodWithFluxReturnType() throws Exception {
		AsyncEndpointCallExecutable<Flux<String>, String> executable = adapter
