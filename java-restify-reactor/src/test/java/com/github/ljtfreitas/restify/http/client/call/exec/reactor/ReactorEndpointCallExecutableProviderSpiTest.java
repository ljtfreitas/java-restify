...
public class ReactorEndpointCallExecutableProviderSpiTest {
	...
	public void shouldDiscoveryServiceProviders() {
		...
		assertThat(services, contains(
				instanceOf(MonoEndpointCallExecutableAdapter.class),
				instanceOf(FluxEndpointCallExecutableAdapter.class)));
	}
}
