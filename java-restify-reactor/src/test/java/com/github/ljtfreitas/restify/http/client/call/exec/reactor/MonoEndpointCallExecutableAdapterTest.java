...
public class MonoEndpointCallExecutableAdapterTest {
	...
	private MonoEndpointCallExecutableAdapter<String, String> adapter;
	...
	public void setup() {
		...
		adapter = new MonoEndpointCallExecutableAdapter<>(scheduler);
	...
	public void shouldCreateExecutableFromEndpointMethodWithMonoReturnType() throws Exception {
		AsyncEndpointCallExecutable<Mono<String>, String> executable = adapter
