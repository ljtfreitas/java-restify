...
public class AcceptHeaderRequestInterceptor implements EndpointRequestInterceptor {

	private HttpMessageConverters messageConverters;

	public AcceptHeaderRequestInterceptor(HttpMessageConverters messageConverters) {
