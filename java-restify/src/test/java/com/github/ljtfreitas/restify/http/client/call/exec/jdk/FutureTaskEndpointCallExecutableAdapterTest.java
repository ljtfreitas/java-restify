...
public class FutureTaskEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<String, String> delegate;

	private FutureTaskEndpointCallExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		ExecutorService executor = Executors.newSingleThreadExecutor();

		adapter = new FutureTaskEndpointCallExecutableAdapter<>(executor);
	...
	public void shouldCreateExecutableFromEndpointMethodWithFutureTaskReturnType() throws Exception {
		EndpointCallExecutable<FutureTask<String>, String> executable = adapter
