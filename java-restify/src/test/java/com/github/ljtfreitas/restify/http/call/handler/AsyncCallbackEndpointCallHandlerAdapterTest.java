...
import com.github.ljtfreitas.restify.http.async.EndpointResponseCallback;
import com.github.ljtfreitas.restify.http.async.EndpointResponseFailureCallback;
...
public class AsyncCallbackEndpointCallHandlerAdapterTest {
	...
	private EndpointMethod createEndpointMethodWithSuccessCallback() throws Exception {
		EndpointMethodParameters parameters = new EndpointMethodParameters()
				.put(new EndpointMethodParameter(0, "callback",
						JavaType.parameterizedType(EndpointCallSuccessCallback.class, null, String.class).unwrap(), EndpointMethodParameterType.ENDPOINT_CALLBACK));
	...
	private EndpointMethod createEndpointMethodWithSingleCallback() throws Exception {
		EndpointMethodParameters parameters = new EndpointMethodParameters()
				.put(new EndpointMethodParameter(0, "callback",
				        JavaType.parameterizedType(EndpointCallCallback.class, null, String.class).unwrap(), EndpointMethodParameterType.ENDPOINT_CALLBACK));
	...
	private EndpointMethod createEndpointMethodWithResponseCallback() throws Exception {
		EndpointMethodParameters parameters = new EndpointMethodParameters()
				.put(new EndpointMethodParameter(0, "callback",
				        JavaType.parameterizedType(EndpointResponseCallback.class, null, String.class).unwrap(), EndpointMethodParameterType.ENDPOINT_CALLBACK));
