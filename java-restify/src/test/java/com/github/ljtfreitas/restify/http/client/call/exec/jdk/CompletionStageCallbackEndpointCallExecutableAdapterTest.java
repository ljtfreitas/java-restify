...
public class CompletionStageCallbackEndpointCallExecutableAdapterTest {
	...
	private CompletionStageCallbackEndpointCallExecutableAdapter<String, String> adapter;

	private SimpleEndpointMethod futureWithCallbackEndpointMethod;

	@Before
	public void setup() throws Exception {
		adapter = new CompletionStageCallbackEndpointCallExecutableAdapter<>(r -> r.run());
