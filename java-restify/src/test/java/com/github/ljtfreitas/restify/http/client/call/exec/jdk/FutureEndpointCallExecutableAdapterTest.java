...
public class FutureEndpointCallExecutableAdapterTest {
	...
	private FutureEndpointCallExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		adapter = new FutureEndpointCallExecutableAdapter<>(r -> r.run());
	...
	public void shouldCreateExecutableFromEndpointMethodWithFutureReturnType() throws Exception {
		AsyncEndpointCallExecutable<Future<String>, String> executable = adapter
