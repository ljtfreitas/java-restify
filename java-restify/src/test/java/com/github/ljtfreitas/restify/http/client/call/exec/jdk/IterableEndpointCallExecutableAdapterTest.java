...
public class IterableEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<Collection<String>, Collection<String>> delegate;

	private IterableEndpointCallExecutableAdapter<String> factory;

	@Before
	public void setup() {
		factory = new IterableEndpointCallExecutableAdapter<>();
	...
	public void shouldCreateExecutableFromEndpointMethodWithIteratorReturnType() throws Exception {
		EndpointCallExecutable<Iterable<String>, Collection<String>> executable = factory.adapt(new SimpleEndpointMethod(SomeType.class.getMethod("iterable")), delegate);
