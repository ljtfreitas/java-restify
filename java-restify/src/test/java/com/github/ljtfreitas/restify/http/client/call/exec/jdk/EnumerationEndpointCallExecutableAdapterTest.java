...
public class EnumerationEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<Collection<String>, Collection<String>> delegate;

	private EnumerationEndpointCallExecutableAdapter<String> adapter;

	@Before
	public void setup() {
		adapter = new EnumerationEndpointCallExecutableAdapter<>();
	...
	public void shouldCreateExecutableFromEndpointMethodWithEnumerationReturnType() throws Exception {
		EndpointCallExecutable<Enumeration<String>, Collection<String>> executable = adapter.adapt(new SimpleEndpointMethod(SomeType.class.getMethod("enumeration")), delegate);
