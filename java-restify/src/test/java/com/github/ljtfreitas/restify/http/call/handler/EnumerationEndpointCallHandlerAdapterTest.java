...
public class EnumerationEndpointCallHandlerAdapterTest {
	...
	public void shouldReturnCollectionParameterizedWithArgumentTypeOfEnumeration() throws Exception {
		assertEquals(JavaType.parameterizedType(Collection.class, null, String.class), adapter.returnType(new SimpleEndpointMethod(SomeType.class.getMethod("enumeration"))));
	}

	@Test
	public void shouldReturnCollectionParameterizedWithObjectWhenEnumerationIsNotParameterized() throws Exception {
		assertEquals(JavaType.parameterizedType(Collection.class, null, Object.class), adapter.returnType(new SimpleEndpointMethod(SomeType.class.getMethod("dumbEnumeration"))));
	}
