...
public class CompletionStageEndpointCallExecutableAdapterTest {
	...
	private CompletionStageEndpointCallExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		adapter = new CompletionStageEndpointCallExecutableAdapter<>(r -> r.run());
	...
	public void shouldCreateExecutableFromEndpointMethodWithCompletableFutureReturnType() throws Exception {
		AsyncEndpointCallExecutable<CompletionStage<String>, String> executable = adapter
