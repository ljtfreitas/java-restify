...
public class AsyncEndpointCallObjectExecutableAdapterTest {
	...
	private AsyncEndpointCallObjectExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		adapter = new AsyncEndpointCallObjectExecutableAdapter<>(r -> r.run());
	...
	public void shouldCreateExecutableFromEndpointMethodWithAsyncEndpoinCallReturnType() throws Exception {
		AsyncEndpointCallExecutable<AsyncEndpointCall<String>, String> executable = adapter
