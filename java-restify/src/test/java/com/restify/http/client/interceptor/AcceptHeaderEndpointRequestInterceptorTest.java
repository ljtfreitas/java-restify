...
public class AcceptHeaderEndpointRequestInterceptorTest {
	...
	public void setup() throws Exception {
		...
		when(httpTextMessageConverterMock.canRead(String.class)).thenReturn(true);
		...
		when(httpJsonMessageConverterMock.canRead(Object.class)).thenReturn(true);

		when(httpXmlMessageConverterMock.canRead(Object.class)).thenReturn(true);
