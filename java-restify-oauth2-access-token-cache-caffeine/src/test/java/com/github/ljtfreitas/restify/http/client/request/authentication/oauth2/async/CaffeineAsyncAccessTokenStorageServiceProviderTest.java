...
public class CaffeineAsyncAccessTokenStorageServiceProviderTest {

	@Test
	public void shouldDiscoveryCaffeineAsyncAccessTokenStorageService() {
		...
		assertThat(service.get(), instanceOf(CaffeineAsyncAccessTokenStorage.class));
	}
}
