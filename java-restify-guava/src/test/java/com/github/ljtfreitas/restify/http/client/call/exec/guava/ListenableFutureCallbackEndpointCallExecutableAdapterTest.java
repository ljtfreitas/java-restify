...
public class ListenableFutureCallbackEndpointCallExecutableAdapterTest {
	...
	private ListenableFutureCallbackEndpointCallExecutableAdapter<String, String> adapter;

	private SimpleEndpointMethod futureWithCallbackEndpointMethod;

	@Before
	public void setup() throws Exception {
		adapter = new ListenableFutureCallbackEndpointCallExecutableAdapter<>(MoreExecutors.newDirectExecutorService());
	...
	public void shouldCreateExecutableFromEndpointRunnableAsyncMethodWithFutureCallbackParameter() throws Exception {
		AsyncEndpointCallExecutable<Void, String> executable = adapter.adaptAsync(futureWithCallbackEndpointMethod, delegate);
