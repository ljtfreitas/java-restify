...
public class ListenableFutureEndpointCallExecutableAdapterTest {
	...
	private ListenableFutureEndpointCallExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		adapter = new ListenableFutureEndpointCallExecutableAdapter<>(MoreExecutors.newDirectExecutorService());
	...
	public void shouldCreateExecutableFromEndpointMethodWithListenableFutureReturnType() throws Exception {
		AsyncEndpointCallExecutable<ListenableFuture<String>, String> executable = adapter
