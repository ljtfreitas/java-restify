...
public class RxJavaCompletableEndpointCallExecutableAdapterTest {

	@Mock
	private AsyncEndpointCall<Void> endpointCall;

	private RxJavaCompletableEndpointCallExecutableFactory adapter;
	...
	public void setup() {
		...
		adapter = new RxJavaCompletableEndpointCallExecutableFactory(scheduler);
	}
	...
	public void shouldCreateExecutableFromEndpointMethodWithRxJavaCompletableReturnType() throws Exception {
		AsyncEndpointCallExecutable<Completable, Void> executable = adapter
