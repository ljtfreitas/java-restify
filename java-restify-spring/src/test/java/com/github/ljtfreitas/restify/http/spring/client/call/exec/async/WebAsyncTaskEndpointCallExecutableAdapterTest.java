...
public class WebAsyncTaskEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<String, String> delegate;

	private WebAsyncTaskEndpointCallExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		adapter = new WebAsyncTaskEndpointCallExecutableAdapter<>();
	...
	public void shouldCreateExecutableFromEndpointMethodWithWebAsyncTaskReturnType() throws Exception {
		EndpointCallExecutable<WebAsyncTask<String>, String> executable = adapter
