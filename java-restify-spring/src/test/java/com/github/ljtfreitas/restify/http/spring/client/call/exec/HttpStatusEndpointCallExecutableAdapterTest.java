...
public class HttpStatusEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<ResponseEntity<Void>, Void> delegate;

	@InjectMocks
	private HttpStatusEndpointCallExecutableAdapter adapter;
	...
	public void shouldCreateExecutableWithResponseEntityReturnType() throws Exception {
		EndpointCallExecutable<HttpStatus, Void> executable = adapter
