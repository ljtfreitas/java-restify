...
public class DeferredResultEndpointCallExecutableAdapterTest {
	...
	private DeferredResultEndpointCallExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		adapter = new DeferredResultEndpointCallExecutableAdapter<>(new SyncTaskExecutor());
	...
	public void shouldCreateExecutableFromEndpointMethodWithDeferredResultReturnType() throws Exception {
		AsyncEndpointCallExecutable<DeferredResult<String>, String> executable = adapter
