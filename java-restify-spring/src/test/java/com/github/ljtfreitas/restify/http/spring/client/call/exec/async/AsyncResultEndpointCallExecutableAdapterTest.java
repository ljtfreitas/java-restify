...
public class AsyncResultEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<String, String> delegate;

	private AsyncResultEndpointCallExecutableAdapter<String, String> adapter;

	@Before
	public void setup() {
		adapter = new AsyncResultEndpointCallExecutableAdapter<>(r -> r.run());
	...
	public void shouldCreateDecoratedExecutableFromEndpointMethod() throws Exception {
		EndpointCallExecutable<AsyncResult<String>, String> executable = adapter
