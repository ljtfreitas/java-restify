...
public class HttpHeadersEndpointCallExecutableAdapterTest {

	@Mock
	private EndpointCallExecutable<ResponseEntity<Void>, Void> delegate;

	@InjectMocks
	private HttpHeadersEndpointCallExecutableAdapter adapter;
	...
	public void shouldCreateExecutableWithResponseEntityReturnType() throws Exception {
		EndpointCallExecutable<HttpHeaders, Void> executable = adapter
